...
exports.Module = class extends React.Component {
    render() {
        ...
        if (!item) return null;
        return <View onLayout={e => this.onLayout(e.nativeEvent)}>
            <View style={[floorStyles.floor, { marginBottom: index == 0 && item.tplId == 13 ? px(0) : px(20), paddingBottom: index == 0 && item.tplId == 13 ? px(0) : px(20) }]}>
